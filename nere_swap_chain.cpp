...
VkResult NereSwapChain::acquireNextImage(uint32_t *imageIndex) {
  vkWaitForFences(
      device.device(),
      1,
...
void NereSwapChain::createSwapChain() {
...
void NereSwapChain::createImageViews() {
...
void NereSwapChain::createRenderPass() {
...
void NereSwapChain::createFramebuffers() {
...
void NereSwapChain::createDepthResources() {
...
void NereSwapChain::createSyncObjects() {
...
VkPresentModeKHR NereSwapChain::chooseSwapPresentMode(const std::vector<VkPresentModeKHR> &availablePresentModes) {
...
VkExtent2D NereSwapChain::chooseSwapExtent(const VkSurfaceCapabilitiesKHR &capabilities) {
...
VkFormat NereSwapChain::findDepthFormat() {
